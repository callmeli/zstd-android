...
/*
 * Class:     com_monstertoss_zstd_1android_ZstdInputStream
 * Method:    recommendedDInSize
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdInputStream_recommendedDInSize
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdInputStream_recommendedDOutSize
  (JNIEnv *env, jclass obj) {
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_monstertoss_zstd_1android_ZstdInputStream_createDStream
  (JNIEnv *env, jclass obj) {
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdInputStream_freeDStream
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdInputStream_initDStream
  (JNIEnv *env, jclass obj, jlong stream) {
 ...
 * Signature: (J[BI[BI)I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdInputStream_decompressStream
