...
/*
 * Class:     com_monstertoss_zstd_1android_ZstdDirectBufferCompressingStream
 * Method:    recommendedCOutSize
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferCompressingStream_recommendedCOutSize
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferCompressingStream_createCStream
  (JNIEnv *env, jclass obj) {
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferCompressingStream_freeCStream
 ...
 * Signature: (JI)I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferCompressingStream_initCStream
 ...
 */
JNIEXPORT jlong JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferCompressingStream_compressDirectByteBuffer
 ...
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferCompressingStream_endStream
 ...
 * Signature: (JLjava/nio/ByteBuffer;II)I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferCompressingStream_flushStream
  (JNIEnv *env, jclass obj, jlong stream, jobject dst_buf, jint dst_offset, jint dst_size) {
