...
/*
 * Class:     com_monstertoss_zstd_1android_ZstdDirectBufferDecompressingStream
 * Method:    recommendedDOutSize
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferDecompressingStream_recommendedDOutSize
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferDecompressingStream_createDStream
  (JNIEnv *env, jclass obj) {
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferDecompressingStream_freeDStream
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferDecompressingStream_initDStream
  (JNIEnv *env, jclass obj, jlong stream) {
 ...
 */
JNIEXPORT jlong JNICALL Java_com_monstertoss_zstd_1android_ZstdDirectBufferDecompressingStream_decompressStream
